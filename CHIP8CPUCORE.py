...
class chip8core:
    def initialize(self):
        ...
        '''
        global pc, I, V, stack, sp, memory, gfx, delay_timer, sound_timer, surf, keys, window, drawflag, mem_change, mem_gfx
    ...
    def execute_opcode(opcode):
        ...
        '''
        global pc, I, V, stack, sp, memory, gfx, delay_timer, sound_timer, drawflag, mem_change, mem_gfx
    ...
    def setkeys(self):
        ...
        '''
        global mem_change, mem_gfx
        state = [0 for i in range(16)]

        for event in pygame.event.get():
            #Quits game; ctrl+w
            if event.type == pygame.QUIT:
                print sorted(list(mem_change))
                print len(mem_change)
                sys.exit()
